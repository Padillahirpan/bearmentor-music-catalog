    ...
    <div className="min-h-screen bg-gray-100 flex flex-col justify-center items-center p-4">
      <div className="bg-white shadow-md rounded-lg p-8 max-w-4xl w-full">
        <h1 className="text-4xl font-bold text-gray-900 mb-4 text-center">
          Welcome to MusicHits2000 REST API
        </h1>
        <p className="text-lg text-gray-700 mb-6 text-center">
          MusicHits2000 REST API is a web service that provides access to a vast
          collection of movie data. It allows users to search for movies,
          retrieve movie details, and perform various operations related to
          movies.
        </p>
